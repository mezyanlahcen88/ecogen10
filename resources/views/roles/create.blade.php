...
@section('title')
{{env('APP_NAME')}} | {{ trans('translation.role_form_manage_roles') }} {{ trans('translation.role_action_add') }}
...
<label for="role"> {{ trans('translation.role_form_role') }} &nbsp; <span
                                ...
                                <input type="text" class="form-control" name="name" id="name"
                                    ...
                                    placeholder=" {{ trans('translation.role_form_role_name_placeholder') }}"
                                    value="{{ old('name') }}">
                            </div>
                            @error('name')
                            ...
                            <div class="col-md-3">
                                <div class="card border card-border-secondary">
                                    <div class="card-header">
                                        <h6 class="card-title mb-0 text-center">{{ $groupe->name }}</h6>
                                    </div>
                                    <div class="card-body">
