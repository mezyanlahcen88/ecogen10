    ...
    <table id="scroll-horizontal" class="table nowrap align-middle table-hover table-bordered"  style="width:100%">
                <thead class="table-light">
                    <tr class="text-center">
                        ...
                        <th class="sort" data-sort="visible">{{ trans('translation.language_table_visible')}}
                ...
                <tbody class="list form-check-all">
                    ...
                    <tr class="text-center">
                        ...
                        <td class="status">
                            ...
                            <input class="form-check-input changeStatus" data-route-name="{{ route('systemLanguages.changestatus') }}" type="checkbox" role="switch"  data-id="{{$object->id}}" {{$object->status ? "checked" : ""}} >
                        </div>
                    </td>
                    <td class="visible">
                        <div class="form-check form-switch d-flex justify-content-center">
