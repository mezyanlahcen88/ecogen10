...
<head>
  ...
  <link rel="stylesheet" href="{{URL::asset('assets/pdf/css/style.css')}}">
</head>
...
<body>
      ...
      <div class="cs-invoice_in" id="download_section">
        <div class="cs-invoice_head cs-type1 cs-mb25">
          ...
          <div class="cs-invoice_right cs-text_right">
            <div class="cs-logo cs-mb5"><img src="{{URL::asset('assets/img/logo.svg')}}" alt="Logo"></div>
          </div>
        </div>
  ...
  <script src="{{URL::asset('assets/pdf/js/jquery.min.js')}}"></script>
  <script src="{{URL::asset('assets/pdf/js/jspdf.min.js')}}"></script>
  <script src="{{URL::asset('assets/pdf/js/html2canvas.min.js')}}"></script>
  <script src="{{URL::asset('assets/pdf/js/main.js')}}"></script>
</body>
</html>
