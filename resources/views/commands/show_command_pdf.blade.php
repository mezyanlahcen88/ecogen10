        ...
        <div class="tm_invoice_in">
          ...
          <div class="tm_invoice_info tm_mb30 tm_align_center">
            <div class="tm_invoice_info_left tm_mb20_md">
              <p class="tm_mb0">
                <b class="tm_primary_color">Command: </b>#{{$command->command_code}} <br>
                <b class="tm_primary_color">Date du command: </b> {{ Carbon\Carbon::parse($command->created_at )->format('d/m/Y') }}
              </p>
            </div>
            <div class="tm_invoice_info_right">
              <div class="tm_border tm_accent_border_20 tm_radius_0 tm_accent_bg_10 tm_curve_35 tm_text_center">
                <div>
                  <b class="tm_accent_color tm_f26 tm_medium tm_body_lineheight">Total: {{$command->TTTC}} DH</b>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <tbody>
                    <tr>
                      <td class="tm_width_6 tm_border_top_0">
                        <b class="tm_primary_color tm_medium">Nom: </b>{{$command->client->getDesignation()}}
                      </td>
                      <td class="tm_width_6 tm_border_top_0 tm_border_left tm_accent_border_20">
                        <b class="tm_primary_color tm_medium">Téléphone: </b> {{$command->client->phone}}
                      </td>
                    </tr>
                    <tr>
                      <td class="tm_width_6 tm_accent_border_20">
                        <b class="tm_primary_color tm_medium">Email: </b>{{$command->client->email}}
                      </td>
                      <td class="tm_width_6 tm_border_left tm_accent_border_20">
                        <b class="tm_primary_color tm_medium">Adresse: </b>{{$command->client->address}}
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table class="tm_mb15 tm_m0_md">
                  <tbody>
                    <tr>
                      ...
                      <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_medium">{{$command->HT}} DH</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0">{{$command->TVA}} DH</td>
                    </tr>
                    <tr class="tm_accent_border_20 tm_border">
                      ...
                      <td class="tm_width_3 tm_bold tm_f16 tm_border_top_0 tm_accent_color tm_text_right tm_accent_bg_10">{{$command->TTTC}} DH	</td>
                    </tr>
                  </tbody>
                </table>
              </div>
