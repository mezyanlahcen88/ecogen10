...
@section('title')
    ...
    {{ trans('translation.garanty_action_edit') }}
@stop
@section('css')
...
@section('page-header')
    @include('components.new_breadcrumb', [
        ...
        'subtitle' => trans('translation.garanty_action_edit'),
...
@endsection
@section('content')
    <form action="{{ route('garanties.update',$object->id) }}" method="post" id="garantyForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-9">
                            ...
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <input type="text" class="form-control" data-provider="flatpickr" data-enable-time
                                        ...
                                        placeholder="{{ Carbon\Carbon::now()->format('d-m-Y H:i') }}" name="doe" value="{{$object->doe}}">
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body mx-auto">
                        <div class="profile-user position-relative d-inline-block  mb-4">
                            <img src="{{ URL::asset(getPicture($object->picture,'garanties')) }}"
                    ...
                    <div class="card-footer">
                                ...
                                'column_value' => $object->document_ref,
                                'readonly' => 'false',
                            ])
                    </div>
                </div>
