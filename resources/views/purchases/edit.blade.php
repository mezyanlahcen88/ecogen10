...
@section('title')
    {{ env('APP_NAME') }} | {{ trans('translation.purchase_form_manage_purchases') }} | {{ trans('translation.purchase_action_add') }}
@stop
@section('css')
...
@section('content')
    ...
    @endif
        ...
        <form action="{{route('purchases.update',$object->id)}}" method="post" id="userForm" enctype="multipart/form-data">
            @csrf
             @method('PUT')
            <div class="row">
