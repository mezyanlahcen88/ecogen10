                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            @if (getSettings()['logo'])
                                <img style="width: 100%"
                                    src="{{ URL::asset('storage/images/settings/' . getSettings()['logo']) }}"
                        ...
                        <span class="logo-lg">
                            @if (getSettings()['logo'])
                                <img src="{{ URL::asset('storage/images/settings/' . getSettings()['logo']) }}"
                                    alt="" class="img-responsive">
                            @else
                                <img src="{{ URL::asset('storage/images/settings/default-logo.png') }}" alt=""
                                    class="img-responsive">
                        ...
                        <div class="tab-content position-relative" id="notificationItemsTabContent">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-1">
                                                                    ...
                                                                    <p
                                                                        class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                                        <span><i class="mdi mdi-clock-outline"></i> 4
                                                                            hrs ago</span>
                                                                    </p>
                                                                </div>
                                                                <div class="px-2 fs-15">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-1">
                                                                    ...
                                                                    <div class="fs-13 text-muted">
                                                                        <p class="mb-1">Mentionned you in his comment
                                                                            on 📃 invoice #12501.
                                                                        </p>
                                                                    </div>
                                                                    <p
                            ...
                            <div class="tab-pane fade p-4" id="alerts-tab" role="tabpanel"
                                ...
                                <div class="empty-notification-elem">
                                    <div class="w-25 w-sm-50 pt-3 mx-auto"> <img src="assets/images/svg/bell.svg"
                                            class="img-fluid" alt="user-pic"> </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img src="{{ getUserPicture(Auth::user()->picture) }}" alt=""
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome {{ Auth::user()->lastname }}!</h6>
                        <a class="dropdown-item" href="#"><i
                                class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Profile</span></a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item"
                            href="{{ route('settings.edit', 'update-system-settings') }}"><i
