...
@section('title')
    {{ env('APP_NAME') }} | {{ trans('translation.delivery_form_manage_deliveries') }} | {{ trans('translation.delivery_action_add') }}
@stop
@section('css')
...
@section('content')
    ...
    @endif
        ...
        <form action="{{route('deliveries.update',$object->id)}}" method="post" id="userForm" enctype="multipart/form-data">
            @csrf
             @method('PUT')
            <div class="row">
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\StoreDeliveryRequest') !!}
