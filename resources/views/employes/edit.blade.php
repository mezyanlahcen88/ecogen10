...
@section('title')
    {{ env('APP_NAME') }} | {{ trans('translation.employe_form_manage_employes') }} | {{ trans('translation.employe_action_add') }}
@stop
@section('css')
...
@section('content')
        ...
        <form action="{{route('employes.update',$object->id)}}" method="post" id="userForm" enctype="multipart/form-data">
            @csrf
             @method('PUT')
             <div class="row">
