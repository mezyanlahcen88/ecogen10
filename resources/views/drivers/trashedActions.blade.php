    <div class="d-flex justify-content-center gap-2">
        @can('driver-restore')
        <form action="{{ route('drivers.restore', $object->id)}}" method="POST" id="restoreForm">
            @csrf
            @method('PUT')
        ...
        @endcan
        @can('driver-force-delete')
            <div class="remove">
                <a href="#" class="remove-item-btn" data-bs-toggle="modal"
                data-id="{{ $object->id }}" data-route-name="{{ route('drivers.destroy', 'delete') }}">
