                    ...
                    @foreach ($objects as $object)
                        <tr class="text-center">
                            <td class="email">
                                <div class="d-flex gap-2 align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ getPicture($object->picture,cardocuments) }}" alt="" class="avatar-xs rounded-circle">
                                    </div>
                                </div>
                            </td>
                                @foreach ($tableRows as $key => $value)
                            ...
                            <td>
                                    ...
                                    'restoreRoute'=>'cardocuments.restore',
                                    'forceDeleteRoute'=>'cardocuments.forceDelete',
                                    'restorePermission'=>'cardocuments-restore',
                                    'forceDeletePermission'=>'cardocuments-forse-delete',
                                ])
                            </td>
                        </tr>
                    @endforeach
