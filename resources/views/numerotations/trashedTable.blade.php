    ...
    <table id="scroll-horizontal" class="table nowrap align-middle table-hover table-bordered"  style="width:100%">
                <thead class="table-light">
                    <tr class="text-center">
                        <th>{{ trans('translation.numerotation_table_picture') }}</th>
                    ...
                    @foreach ($objects as $object)
                        <tr class="text-center">
                            ...
                            <td>
                                    ...
                                    'restoreRoute'=>'numerotations.restore',
                                    'forceDeleteRoute'=>'numerotations.forceDelete',
                                    'restorePermission'=>'numerotation-restore',
                                    'forceDeletePermission'=>'numerotation-forse-delete',
                                ])
                            </td>
                        </tr>
                    @endforeach
