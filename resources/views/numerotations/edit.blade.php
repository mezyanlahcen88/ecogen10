...
@section('title')
    {{ env('APP_NAME') }} | {{ trans('translation.numerotation_form_manage_numerotations') }} | {{ trans('translation.numerotation_action_add') }}
@stop
@section('css')
...
@section('content')
    ...
    @endif
        ...
        <form action="{{route('numerotations.update',$object->id)}}" method="post" id="userForm">
            @csrf
             @method('PUT')
            <div class="row">
                    ...
                    <div class="card card-body">
                        <div class="row">
                            ...
                            @include('form.input', [
                                ...
                                'column_value' => $object->increment_num,
                                'readonly' => false,
                            ])
                            <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control ckeditor" name="comments" id="comments" style="height: 213px">{{ $object->comments }}</textarea>
                                </div>
                            </div>
