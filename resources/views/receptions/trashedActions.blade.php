    <div class="d-flex justify-content-center gap-2">
        @can('reception-restore')
        <form action="{{ route('receptions.restore', $object->id)}}" method="POST" id="restoreForm">
            @csrf
            @method('PUT')
        ...
        @endcan
        @can('reception-force-delete')
            <div class="remove">
                <a href="#" class="remove-item-btn" data-bs-toggle="modal"
                data-id="{{ $object->id }}" data-route-name="{{ route('receptions.destroy', 'delete') }}">
