<div class="d-flex flex-column flex-lg-row align-items-sm-center justify-content-between">
    @if($recordCount === 'full')
        <small class="text-muted d-block mb-2 my-md-2 me-1">
            {{ trans('translation.livewire-powergrid::datatable.pagination.showing') }}
            <span class="font-semibold">{{ $paginator->firstItem() }}</span>
            {{ trans('translation.livewire-powergrid::datatable.pagination.to') }}
            <span class="font-semibold">{{ $paginator->lastItem() }}</span>
            {{ trans('translation.livewire-powergrid::datatable.pagination.of') }}
            <span class="font-semibold">{{ $paginator->total() }}</span>
            {{ trans('translation.livewire-powergrid::datatable.pagination.results') }}
        </small>
