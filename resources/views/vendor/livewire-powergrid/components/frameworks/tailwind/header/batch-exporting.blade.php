@if($queues && $showExporting)
    ...
    @if($batchExporting && !$batchFinished)
        <div wire:poll="updateExportProgress"
            ...
            <div class="dark:text-slate-300">{{ trans('translation.livewire-powergrid::datatable.export.exporting') }}</div>
                ...
                <div class="px-4 py-3 rounded-md cursor-pointer bg-slate-100 shadow dark:bg-slate-600"
                    ...
                    <div class="flex justify-between">
                        <button
                            ...
                            type="button">
                            ⚡ {{ trans('translation.livewire-powergrid::datatable.export.completed') }}
                        </button>
